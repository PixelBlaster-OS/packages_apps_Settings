...
public class BatteryHeaderPreferenceController extends BasePreferenceController implements PreferenceControllerMixin, LifecycleObserver, OnStart {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mBatteryMeterView = (BatteryMeterView) layoutPreference.findViewById(R.id.battery_header_icon);
    ...
    public void onStart() {
        EntityHeaderController newInstance = EntityHeaderController.newInstance(this.mActivity, this.mHost, this.mBatteryLayoutPref.findViewById(R.id.battery_entity_header));
    ...
    private CharSequence formatBatteryPercentageText(int i) {
        return TextUtils.expandTemplate(this.mContext.getText(R.string.oneplus_battery_header_title), NumberFormat.getIntegerInstance().format((long) i));
    }
}
