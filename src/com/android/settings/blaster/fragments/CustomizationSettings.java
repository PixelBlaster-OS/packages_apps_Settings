...
import com.blaster.support.preference.SecureSettingSwitchPreference;
...
public class CustomizationSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNetworkTraffic.setEntries(CustomUtils.hasNotch(getActivity()) ? NotchEntries : NonNotchEntries);
        mNetworkTraffic.setEntryValues(CustomUtils.hasNotch(getActivity()) ? NotchValues : NonNotchValues);
